...
# ──────────────────────────────────────────────────────────────
SCRIPT_DIR = 'data/SabDab-RELAAI'
H5_PATH  = os.path.join(SCRIPT_DIR, "SabDab_RELAAI_esmt36_Full.h5")
CSV_PATH = os.path.join(SCRIPT_DIR, "AbAg_record_level_balanced_dataset.csv")
