...
# ──────────────────────────────────────────────────────────────
SCRIPT_DIR = '../RLEAAI/data/HIV/'
H5_PATH  = os.path.join(SCRIPT_DIR, "HIV-RLEAAI-ProtT5-Full.h5")
CSV_PATH ="https://github.com/zhouyu9931/RLEAAI/raw/refs/heads/main/data/dataset_hiv.xlsx"
...
CONFIG = {
    ...
    "random_state"    : SEED,
    # ── training schedule
    "epochs"          : 100,          # quick 3-epoch run per fold
